...
%filename='YAHOO-INDEX_DJI-1985-1987.xls';
%DOW 
...
for i =1609:1740
    ...
    %DailyReturn = gdivide(columnClose1(1:8023),columnClose1(2:8024))-1;

    DailyReturn = gdivide(columnClose1(2:length(columnClose1)),columnClose1(1:length(columnClose1)-1))-1;
    %DailyReturn = gdivide(columnClose1(2:739),columnClose1(1:738))-1;
    %DailyReturn=columnClose1;
    ...
    for t=1:T
      ...
      %X(t)=cos(t/50)+10;
      %X(t) = DailyReturn(8024-t);
      X(t) = DailyReturn(t);
      %X(t)=DailyReturn(739-t);
      %X(t)=mod(t,200)/100 +50;
    end
